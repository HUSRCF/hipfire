            ...
            "img_generate" => {
                ...
                if !matches!(
                    ...
                    emit_uncorrelated_error(
                        ...
                        Some(id.as_str()),
                        &format!(
                            "unsupported sampler {sampler:?}: only euler (flow-match) is supported"
                        ),
                        "validation",
                        false,
                        false,
                ...
                let backend = msg.get("backend").and_then(|v| v.as_str()).unwrap_or("gpu");
                ...
                let steps = match msg.get("steps").and_then(|v| v.as_u64()) {
                ...
                let seed = msg.get("seed").and_then(|v| v.as_u64()).unwrap_or(0);
                ...
                match result {
                    Ok(out) => {
                        let png_b64 = {
                            ...
                            base64::engine::general_purpose::STANDARD.encode(&out.png)
                        };
